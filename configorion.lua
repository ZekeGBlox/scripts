...
local AddConnection = game.DescendantAdded.Connect
...
local function LoadCfg(Config)
	...
	table.foreach(Data, function(a,b)
		if OrionLib.Flags[a] then
			...
			warn("Config Loader Error - Couldn't find ", a ,b)
		end
	end)
end
...
function OrionLib:MakeWindow(WindowConfig)
	...
	AddConnection(UserInputService.InputBegan, function(Input)
		if UIHidden and Input.KeyCode == Enum.KeyCode.RightShift then
	...
	local LoadSequenceText = SetProps(MakeElement("Label", WindowConfig.Name, 14), {
		Parent = Orion,
		Size = UDim2.new(1, 0, 1, 0),
		AnchorPoint = Vector2.new(0.5, 0.5),
			...
			function ElementFunction:AddColorpicker(ColorpickerConfig)
				...
				AddConnection(Color.InputBegan, function(input)
					if input.UserInputType == Enum.UserInputType.MouseButton1 then
						...
						ColorInput = AddConnection(RenderStepped, function()
				...
				AddConnection(Color.InputEnded, function(input)
					if ColorInput and input.UserInputType == Enum.UserInputType.MouseButton1 then
						ColorInput:Disconnect()
					end
				end)
				...
				AddConnection(Hue.InputBegan, function(input)
					if input.UserInputType == Enum.UserInputType.MouseButton1 then
						...
						HueInput = AddConnection(RenderStepped, function()
